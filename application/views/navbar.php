...
<header class="navbar navbar-sticky">
  ...
  <div class="site-branding">
    <div class="inner">
      ...
      <!-- Site Logo--><a class="site-logo" href="index.html"><img src="<?php echo base_url().IMG_PATH;?>logo/logo.png" alt="Unishop"></a>
    </div>
  </div>
  <!-- Main Navigation-->
...
<nav class="site-menu">
    <ul>
      <li class="has-megamenu"><a href="index.html"><span>Home</span></a>
        <ul class="mega-menu">
          <li><a class="d-block img-thumbnail text-center navi-link" href="index.html"><img alt="Featured Products Slider" src="<?php echo base_url().IMG_PATH;?>mega-menu-home/01.jpg">
              <h6 class="mt-3">Featured Products Slider</h6></a></li>
          <li><a class="d-block img-thumbnail text-center navi-link" href="home-featured-categories.html"><img alt="Featured Categories" src="<?php echo base_url().IMG_PATH;?>mega-menu-home/02.jpg">
              <h6 class="mt-3">Featured Categories</h6></a></li>
          <li><a class="d-block img-thumbnail text-center navi-link" href="home-collection-showcase.html"><img alt="Products Collection Showcase" src="<?php echo base_url().IMG_PATH;?>mega-menu-home/03.jpg">
              <h6 class="mt-3">Products Collection Showcase</h6></a></li>
          <li>
            <div class="img-thumbnail text-center"><img alt="More To Come. Stay Tuned!" src="<?php echo base_url().IMG_PATH;?>mega-menu-home/04.jpg">
